...
namespace ConsoleApplication1_lat_lon_decimail_to_degree
{
    class Program
    {
        ...
        static string decimal_to_degree(double decimal_degrees)
        {
            ;
            ...
            return minutes.ToString() + seconds.ToString() + "." + tenths.ToString();
        }
